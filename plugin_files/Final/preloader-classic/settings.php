<?php
    ...
    function WPTime_preloader_register_settings() {
        ...
        register_setting( 'WPTime_preloader_register_setting', 'wpt_thepreloader_image_size_get_width' );
        register_setting( 'WPTime_preloader_register_setting', 'wpt_thepreloader_image_size_get_height' );
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description">Enter preloader image width size, digit only. Ex: '256' (Pixel) [Default is '64' (Pixel)] </p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description">Enter preloader image height size, digit only. Ex: '256' (Pixel) [Default is '64' (Pixel)]</p>
