                    ...
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="small-text" name="wptpreloader_image_width" type="text" id="wptpreloader_image_width" value="<?php echo esc_attr( $image_width ); ?>">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="small-text" name="wptthepreloader_image_height" type="text" id="wptthepreloader_image_height" value="<?php echo esc_attr( $image_height ); ?>">
